...
export class AcrFormComponent implements OnInit {
  ...
  constructor(
    ...
    this.agencyForm = new FormGroup({
      ...
      secondaryPersonName: new FormControl('', [Validators.required, Validators.pattern(Patterns.name)]),
      secondaryPersonDesignation: new FormControl('', [Validators.required]),
      secondaryPersonEmail: new FormControl('', [Validators.required, Validators.pattern(Patterns.email)]),
      secondaryPersonPhone: new FormControl('', [Validators.required, Validators.pattern(Patterns.mobile)]),
